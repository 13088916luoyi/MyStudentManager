...
template <> constexpr inline auto student::qt_create_metaobjectdata<qt_meta_tag_ZN7studentE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_watch_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_count_clicked'
...
void student::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_watch_clicked(); break;
        case 2: _t->on_count_clicked(); break;
        case 3: _t->on_refresh_clicked(); break;
        case 4: _t->showCellTooltip((*reinterpret_cast<std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        default: ;
        }
    }
}
